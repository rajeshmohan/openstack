...
class TestAttributes(base.BaseTestCase):
    ...
    def test_validate_service_context(self):
        ...
        service_ctxt1 = {"routers": ['e5069610-744b-42a7-8bd8-ceac1a229cd4',
                                     'b0c4bff0-96bb-4cc4-956c-422df62a3014']}
        ...
        msg = attributes._validate_service_context(service_ctxt,
                                                   None)
        supported_insertions = set(constants.SI_SUPPORTED_RESOURCE_TYPES)
        error = (_("Not a valid Service context: "
                   "Supported keys: %(supported_keys)s "
                   "Provided keys: %(provided_keys)s") %
                 {'supported_keys': supported_insertions,
