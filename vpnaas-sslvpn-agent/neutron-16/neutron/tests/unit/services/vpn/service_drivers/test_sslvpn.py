...
class TestSSLVPNDriver(base.BaseTestCase):
    def setUp(self):
        super(TestSSLVPNDriver, self).setUp()
        ...
        self.driver = sslvpn_driver.SSLVPNDriver(service_plugin)
    ...
    def _test_update(self, func, args):
        ...
        with mock.patch.object(self.driver.agent_rpc, 'cast') as cast:
            ...
            cast.assert_called_once_with(
                ...
                version='1.0',
                topic='ssl_vpn_agent.fake_host')

    def test_create_ssl_vpn_connection(self):
        self._test_update(self.driver.create_ssl_vpn_connection,
                          [FAKE_VPN_CONNECTION])

    def test_update_ssl_vpn_connection(self):
        self._test_update(self.driver.update_ssl_vpn_connection,
                          [FAKE_VPN_CONNECTION, FAKE_VPN_CONNECTION])

    def test_delete_ssl_vpn_connection(self):
        self._test_update(self.driver.delete_ssl_vpn_connection,
                          [FAKE_VPN_CONNECTION])
