...
class BaseSwanProcess(linux_driver.BaseLinuxProcess):
    ...
    def __init__(self, conf, root_helper, process_id,
        ...
        config_dir = os.path.join(
            cfg.CONF.ipsec.config_base_dir, process_id)
        super(BaseSwanProcess, self).__init__(
